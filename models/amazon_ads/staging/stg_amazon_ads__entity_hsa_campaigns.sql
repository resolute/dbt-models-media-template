...
source_data AS (
    ...
    SELECT * FROM {{ source('improvado', 'amazon_advertising_entity_hsa_campaigns') }}
...
rename_recast AS (
    ...
    SELECT
        ...
        serving_status AS campaign_serving_status,
        bid_optimization AS campaign_bid_optimization,
        portfolio_id,
        spending_policy AS campaign_spending_policy
