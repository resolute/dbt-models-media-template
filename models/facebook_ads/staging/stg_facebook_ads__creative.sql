...
rename_recast AS (
    ...
    SELECT
        ...
        COALESCE(account.account_name, source_data.account_name) AS account_name,
        source_data.date,
        source_data.campaign_id,
        COALESCE(campaign.campaign_name, source_data.campaign_name) AS campaign_name,
        ...
        COALESCE(adset.adset_name, source_data.adset_name) AS adset_name,
        ...
        source_data.ad_id,
        COALESCE(ad.ad_name, source_data.ad_name) AS ad_name,
        ...
        COALESCE(creative.creative_name, source_data.creative_name) AS creative_name,
...
final AS (
    ...
    SELECT 
        ...
        {{ dbt_utils.generate_surrogate_key(['date', 'account_id', 'ad_id', 'creative_id', 'publisher_platform']) }} AS id,
