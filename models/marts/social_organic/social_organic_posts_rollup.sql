...
set upstream_models = {
    'facebook': {
        ...
        'model_ref': 'facebook_organic__posts_lifetime'
    },
    'instagram': {
        'has_data': var('instagram_organic_ids') != None,
        'model_ref': 'instagram_organic__posts_lifetime'
    },
    'twitter': {
        'has_data': var('twitter_organic_ids') != None,
        'model_ref': 'twitter_organic__posts_lifetime'
    },
    'linkedin': {
        'has_data': var('linkedin_organic_ids') != None,
        'model_ref': 'linkedin_organic__posts_lifetime'
    }
}
-%}
