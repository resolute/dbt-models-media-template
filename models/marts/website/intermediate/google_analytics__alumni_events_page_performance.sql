...
data AS (
    ...
    SELECT * FROM {{ ref('stg_google_analytics__alumni_events_page_performance') }}
...
final AS (
    ...
    SELECT
        ...
        SUM(website_pageviews) AS website_alumni_events_pageviews,
        SUM(website_pageviews_unique) AS website_alumni_events_pageviews_unique
