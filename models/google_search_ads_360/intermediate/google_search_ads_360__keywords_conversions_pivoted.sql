...
data AS (
    ...
    SELECT * FROM {{ ref('google_search_ads_360__keywords_conversions_pivot_prep') }}
...
pivot_conversions AS (
    ...
    SELECT
        ...
        {%- set conv_cat_values = dbt_utils.get_column_values(ref('google_search_ads_360__keywords_conversions_pivot_prep'), 'floodlight_group_formatted') -%}
        ...
        {%- set conv_name_values = dbt_utils.get_column_values(ref('google_search_ads_360__keywords_conversions_pivot_prep'), 'floodlight_activity_formatted') -%}
