...
final AS (
    ...
    SELECT 
        ...
        {{ dbt_utils.generate_surrogate_key(['date', 'account_id', 'advertiser_id', 'site_id', 'placement_id', 'placement_size', 'ad_id', 'creative_id', 'asset', 'platform_type', 'browser_platform', 'connection_type', 'creative']) }} AS id,
